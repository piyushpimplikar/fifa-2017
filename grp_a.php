...
<br>
 ...
 <div class="f1">GROUP A </div>
<br>
<?php
  $country1=$conn->query("select Country from Group_A where Position=1;");
  ...
  $country2=$conn->query("select Country from Group_A where Position=2;");
  ...
  $country3=$conn->query("select Country from Group_A where Position=3;");
  ...
  $country4=$conn->query("select Country from Group_A where Position=4;");
